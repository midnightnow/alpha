...
# Temporal Polynomial: x⁴ − 186x² + 81 = 0
# Roots define the Hades Beat (±0.660688 Hz) and the High Harmonic (±13.638 Hz)
# Note: √42 and √51 are roots of the Geometric Polynomial (x⁴ − 93x² + 2142 = 0)
POLY_ROOTS = [
    np.sqrt(93 - 2*np.sqrt(2142)),  # ≈ 0.660688 (Hades Beat)
    np.sqrt(93 + 2*np.sqrt(2142)),  # ≈ 13.638 (High Harmonic)
]
