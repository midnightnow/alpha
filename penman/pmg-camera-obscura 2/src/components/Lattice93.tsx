...
export const Lattice93: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center bg-[#E4E3E0] p-8 rounded-xl border border-[#141414]">
      <div className="w-full flex justify-between mb-4 font-mono text-xs uppercase tracking-widest opacity-50">
        <span>93-Node Phase Matrix</span>
        <span>Σ=4 / √42 / √51</span>
      </div>
      <svg ref={svgRef} className="w-full max-w-[500px] aspect-square" />
      <div className="mt-6 grid grid-cols-2 gap-4 w-full font-mono text-[10px] uppercase">
