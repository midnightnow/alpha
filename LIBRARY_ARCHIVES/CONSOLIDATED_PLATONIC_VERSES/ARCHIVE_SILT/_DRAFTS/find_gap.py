...
ideal_energy = np.sum(np.abs(wait_signal * io_switch))
actual_energy = np.sum(weight_distribution)

print("Ideal:", ideal_energy)
print("Actual:", actual_energy)
print("Gap:", abs(ideal_energy - actual_energy) / ideal_energy)
print("Gap2:", abs(ideal_energy - actual_energy * buffer_size) / ideal_energy)
