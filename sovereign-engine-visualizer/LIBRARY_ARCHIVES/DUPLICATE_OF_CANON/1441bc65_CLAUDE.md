...
- Book 1: Mythological foundation (Void, Line, Angle, Plane, Solid) — SEALED
- Book 2: `/Book_2_Code_of_the_Cosmos/` — SEALED
- Book 3: `/Book_3_Voices_of_the_Void/` — SEALED
- Book 7: 154 Shakespeare sonnet analyses — SEALED
...
- `/archive/PlatonicVerses_v1.0/PlatonicVerses Chapters/PlatonicVerses_Complete_Book1.md` — Book 1 complete
- `PlatonicVerses Chapters/Book_2_Code_of_the_Cosmos/` — Book 2 complete
- `PlatonicVerses Chapters/` individual sonnet files — Book 7 complete
...
**Branches:** `develop` for PRs. Current active: `feat/vetsorcery-base`
...
- **VetSorcery** — veterinary workflow optimization (PMG geometry in clinical routing)
- **AIVA Voice SDK** — voice-controlled coding (phoneme bridge)
